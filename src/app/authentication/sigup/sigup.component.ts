...
export class SigupComponent implements OnInit,OnDestroy  {
  ...
  constructor(private router:Router, private authService: AuthenticonService,private matchPasswpord:MatchPasswordService,private uniqService:UniqUsernameService,private cookieService: CookieService) {
